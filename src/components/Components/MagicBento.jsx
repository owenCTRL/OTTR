...
const cardData = [
  ...
  },
  {
    color: "#000000",
    title: "Analytics",
    description: "Track your Strategies",
    label: "Insights",
  },
  {
    color: "#000000",
    title: "Collaboration",
    description: "Edit Goals and Strategies on the fly",
    label: "Customization",
  },
  {
    color: "#000000",
    title: "Automation",
    description: "Streamline Strategy implementation",
    label: "Efficiency",
  },
  {
    color: "#000000",
...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid gap-4 p-6 max-w-[80rem] w-full select-none relative"
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative aspect-[4/3] min-h-[200px] w-full max-w-full p-6 rounded-[20px] border border-solid overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${enableBorderGlow ? "card--border-glow" : ""
              }`;
